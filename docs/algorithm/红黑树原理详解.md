...
![image](https://static.lovedata.net/21-06-21-876c70ae09eb65e0395250fee6bf8cf0.png)
...
![image](https://static.lovedata.net/21-06-21-4f6940823caef6f1c4ed938eb2c831f3.png)
...
![image](https://static.lovedata.net/21-06-21-847d01a7018050b4bcefa1e792c87dd4.png)
...
二叉搜索树要求：若它的左子树不空，则左子树上所有结点的值均小于它的根结点的值； 
 ...
 它的左、右子树也分别为二叉排序树。
   ...
   ![image](https://static.lovedata.net/21-06-21-355dda1c98a7458ffeefe14a79bd51e7.png)
...
​    ![image](https://static.lovedata.net/21-06-21-e9aa8216bfab7e880a9145b10496b3ae.png)
...
​    ![image](https://static.lovedata.net/21-06-21-90fc0f498ec23eef43d0dde3758bc98c.png)
...
​    ![image](https://static.lovedata.net/21-06-21-2f373881709e4d53af62c7b276bf2d7e.png)

**②、删除有一个子节点的节点**

删除有一个子节点的节点，我们只需要将其父节点原本指向该节点的引用，改为指向该节点的子节点即可。

​    ![image](https://static.lovedata.net/21-06-21-8ebd6283d264da14998ac965247ee858.png)

**③、删除有两个子节点的节点**

​    ![image](https://static.lovedata.net/21-06-21-726eb19caabcc11794c35bdc931e64a9.png)
...
​    ![image](https://static.lovedata.net/21-06-21-de70e821af036eb2eac42db9da6c49fd.png)
...
​    ![image](https://static.lovedata.net/21-06-21-fde3ddd9c9b9f3100cffceeacdcb0194.png)
...
![image](https://static.lovedata.net/21-06-21-272b9619efe77dad802373be6797bf87.png)
...
| ![image](https://static.lovedata.net/21-06-21-e6925bceeb94bc80ec7806e09c6d25b1.png) |
...
![image](https://static.lovedata.net/21-06-21-ee3d2479d86aebdc8365989293e53dcd.png) 

**右旋图示**

![image](https://static.lovedata.net/21-06-21-7f972f48c86d47e7b345a3a955d683f7.png)

**红黑树查找：**

![image](https://static.lovedata.net/21-06-21-f7d33d8c35ce5e573eb9d14c1dbce346.png)
...
​    ![image](https://static.lovedata.net/21-06-21-03379d1ef990643eab5df6099898700f.png)
...
![image](https://static.lovedata.net/21-06-21-be61830b5e8d4d82f070785ec4ab69a0.png)

**情景3：插入结点的父结点为黑结点**

由于插入的结点是红色的，当插入结点的黑色时，并不会影响红黑树的平衡，直接插入即可，无需做自平衡。

![image](https://static.lovedata.net/21-06-21-95b2b5a16ae78987fe1b14b49a268c8b.png)    
...
![image](https://static.lovedata.net/21-06-21-b0e936198ba705fc6533f411cddfb46d.png)
...
![image](https://static.lovedata.net/21-06-21-d562caeb27c29ca929691c897ac157a4.png)
...
![image](https://static.lovedata.net/21-06-21-1e1748cdd925c7ab2aa88e7233600338.png)

**插入情景4.2.1：新插入节点，为其父节点的左子节点（LL红色情况）**

​    ![image](https://static.lovedata.net/21-06-21-baee016d280ef74b3c73376b492e613a.png)
...
​    ![image](https://static.lovedata.net/21-06-21-fb8992c84a9767348287390cb04f753d.png)

**插入情景4.2.2：新插入节点，为其父节点的右子节点（LR红色情况）**

​    ![image](https://static.lovedata.net/21-06-21-c201869c6375040349d5a04216da3f9c.png)
...
![image](https://static.lovedata.net/21-06-21-a0fc9e6a70e83df9615f333d9ab6cff1.png)

**插入情景4.3：****叔叔结点不存在或为黑结点，并且插入结点的父亲结点是祖父结点的右子结点**

该情景对应情景4.2，只是方向反转，直接看图。

​    ![image](https://static.lovedata.net/21-06-21-56df8dfc33bdec5d9acbb598466a3d62.png)

**插入情景4.3.1：新插入节点，为其父节点的右子节点（RR红色情况）**

​    ![image](https://static.lovedata.net/21-06-21-5e9be80c13343ad588abad7fc796f07f.png)
...
​    ![image](https://static.lovedata.net/21-06-21-24d5a0ccc6708e0270c46c20f2170852.png)

**插入情景4.3.2：新插入节点，为其父节点的左子节点（RL红色情况）**

​    ![image](https://static.lovedata.net/21-06-21-dd72b9205cdce7e69c3db3e3d636a83d.png)
...
![image](https://static.lovedata.net/21-06-21-7e3b6deeec1f63ed1d83ba49dbae5156.png)
...
![image](https://static.lovedata.net/21-06-21-ea965682a12028ded967666b00ccb0e0.png)
...
![image](https://static.lovedata.net/21-06-19-fbb46fa2d2dd85f743a3888f168f6840.png)
...
![左旋](https://static.lovedata.net/左旋.gif)

![image](https://static.lovedata.net/21-06-19-5d715d76bcc53e790e889a7abb74a939.png)



### 右旋

![左旋](https://static.lovedata.net/右旋.gif)

![image](https://static.lovedata.net/21-06-19-2d3ab8a73bfe06737eca7997154ea7e4.png)



### 查找

![image](https://static.lovedata.net/21-06-19-9e7b325acac6dc8ba5a72d0baefda31b.png)
...
![image](https://static.lovedata.net/21-06-19-0663bce2243f90a7511a3710ae40e149.png)
...
![image](https://static.lovedata.net/21-06-19-26ee29186481b37f0615e765e1c14f00.png)
...
![image](https://static.lovedata.net/21-06-19-6c9cebc49f8cf2c0064d6f7585d09f6a.png)
...
![image](https://static.lovedata.net/21-06-19-e1538bf679f53889c54e65fc4feeb706.png)
...
![image](https://static.lovedata.net/21-06-19-318e96057a96c80bdc86646a1727e0be.png)
...
![image](https://static.lovedata.net/21-06-19-12a04c419f987afc297245b26b985c65.png)



**插入情景4.2.1:新插入芍点，カ其父芍点的左子芍点(LL紅色情况)**

![image](https://static.lovedata.net/21-06-19-b20194fc538bb066865646170106539e.png)
...
![image](https://static.lovedata.net/21-06-19-6bf1ae57ba79729146a0a64afae5f54a.png)



**插入情景4.2.2:新插入节点，为其父节点的右子节点(LR红色情况)**

![image](https://static.lovedata.net/21-06-19-8c6569399a2ded60f1c4d1cad07a36a4.png)
...
![image](https://static.lovedata.net/21-06-19-9ba66fe62d1cb0c957888cf54e236315.png)
...
![image](https://static.lovedata.net/21-06-19-fb7ddd0fd139cc60627df1471118915f.png)



**插入情景4.3.1:新插入节点，カ其父节点的右子节点(RR紅色情况)**

![image](https://static.lovedata.net/21-06-19-b676e7bdedb2d976a50ca4dff0e58467.png)
...
![image](https://static.lovedata.net/21-06-19-c33cb596e0290873f875c7e8c2d8dd65.png)



**插入情景4.3.2:新插入节点，为其父节点的左子节点(RL红色情况)**

![image](https://static.lovedata.net/21-06-19-412a5ae81ea52a19e68d8f7f71e695f6.png)
...
![image](https://static.lovedata.net/21-06-19-d67e621c35e8842f9659eac53fe3d6a4.png)



### 案例

![image](https://static.lovedata.net/21-06-19-88ab84ee3b8893be8909e62c84002d0d.png)
