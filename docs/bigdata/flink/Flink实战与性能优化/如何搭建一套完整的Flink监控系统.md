...
![images](https://static.lovedata.net/zs/2019-10-03-161007.png)
...
![images](https://static.lovedata.net/zs/2019-10-03-161422.png)
...
![images](https://static.lovedata.net/zs/2019-10-03-162532.png)
...
![images](https://static.lovedata.net/zs/2019-10-03-164158.png)
上面列举了几个 REST
...
![启动 jconsole](https://static.lovedata.net/zs/2019-10-03-150903.png)
![与进程建立连接](https://static.lovedata.net/zs/2019-10-03-151723.png)
如下图所示，你可以看到左侧是有很多的监控指标，如果点进去是可以查看到每个指标对应的 value 值。

![查看 JMX 监控指标](https://static.lovedata.net/zs/2019-10-03-151128.png)
...
![出现 Task Manager 监控数据](https://static.lovedata.net/zs/2019-10-03-155939.png)
...
![images](https://static.lovedata.net/zs/2019-10-04-033753.png)
...
![images](https://static.lovedata.net/zs/2019-09-30-173806.png)
...
![images](https://static.lovedata.net/zs/2019-09-30-174054.png)
...
![images](https://static.lovedata.net/zs/2019-09-30-165151.jpg)
...
![images](https://static.lovedata.net/zs/2019-09-30-170055.jpg)
这时需要使用下面命令的命令才能够登录：
...
![images](https://static.lovedata.net/zs/2019-09-30-170346.jpg)
然后创建一个叫 zhisheng 的数据库，后面会将 Flink 中的监控数据存储到该数据库下。

![images](https://static.lovedata.net/zs/2019-09-30-171008.jpg)
#### 安装 Grafana
...
![images](https://static.lovedata.net/zs/2019-09-30-171436.jpg)
3、启停 Grafana
...
![images](https://static.lovedata.net/zs/2019-10-25-075421.png)
...
![images](https://static.lovedata.net/zs/2019-10-04-132607.png)
2、配置图表从哪个数据源获取数据、选择哪种指标、选择分组、选择单位、添加多个指标、图表命名

![images](https://static.lovedata.net/zs/2019-10-04-133619.png)
![images](https://static.lovedata.net/zs/2019-10-04-133915.png)
![images](https://static.lovedata.net/zs/2019-10-04-134010.png)
3、配置告警

![images](https://static.lovedata.net/zs/2019-10-04-134344.png)
这样一个完整的监控图表就配置出来了，有些指标可能直接用数字展示就比较友好，另外还有就是要注意单位，大家可以好好琢磨研究一下 Grafana
的自定义可视化图表的配置，配置好了比较重要的监控指标之后，效果如下图所示：

![images](https://static.lovedata.net/zs/2019-10-04-134810.png)
![images](https://static.lovedata.net/zs/2019-10-04-134842.png)
好了，一个 Flink
