...
![flink任务task图.png](https://static.lovedata.net/zs/2019-10-07-151541.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151548.jpg)
...
![单并行度 PV 案例 Checkpoint 过程图示1](https://static.lovedata.net/zs/2019-10-07-151547.jpg)
Source Task 安插好 barrier 后，会将 barrier 跟数据一块发送给下游，然后自身开始做快照，并将快照信息
offset(0,60000) 发送到高可用的持久化存储介质，例如 HDFS 上。

![单并行度 PV 案例 Checkpoint 过程图示2](https://static.lovedata.net/zs/2019-10-07-151542.jpg)
下游的 PV task 接收到 barrier 后，也会做快照，并将快照信息 PV：(app1,50000) (app2,10000) 发送到 HDFS。

![images](https://static.lovedata.net/zs/2019-10-07-151543.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151544.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151553.jpg)
当任务从状态恢复时，每个 Operator 从状态后端读取自己相应的状态信息，数据源会从状态中保存的位置开始重新消费，后续的其他算子也会基于
Checkpoint 中保存的状态进行计算。

![多并行度下，任务从 Checkpoint 恢复图示](https://static.lovedata.net/zs/2019-10-07-151556.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151558.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151546.jpg)
假设 barrier 不对齐，那么 Checkpoint 过程是怎么样呢？

![images](https://static.lovedata.net/zs/2019-10-07-151554.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151555.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151552.jpg)
![images](https://static.lovedata.net/zs/2019-10-07-151557.jpg)
2PC 的优点：原理简单，实现方便。
...
![image](https://static.lovedata.net/21-04-01-02f2f4c2f91ef46bff23892030c24dc0.png)
...
![image](https://static.lovedata.net/21-04-01-06265c0033baaaff7be49053a43e0224.png)
...
![images](https://static.lovedata.net/zs/2019-10-07-151549.jpg)
...
![images](https://static.lovedata.net/zs/2019-10-07-151550.jpg)
