...
![image](https://static.lovedata.net/21-06-03-a23a7e41841b1675a3635b891271001b.png)
...
![image](https://static.lovedata.net/21-06-03-cbec43eb5981e04bcfb2ef9930af801f.png)
...
- 加载扩展类和应用程序类加载器，并指定为他们的父类加载器。
  ...
  ![image](https://static.lovedata.net/21-06-03-2b4b84f416fee96dd82061fe4d318162.png)
  ![image](https://static.lovedata.net/21-06-03-ed7e141dc7634a368c83233606ec78c7.png)
...
**执行结果：**
![image](https://static.lovedata.net/21-06-03-3381e1754438c8aa9b9a5e1556826555.png)
...
- 从java.ext.dirs系统属性所指定的目录中加载类库，或从JDK的安装目录的jre/lib/ext子目录下加载类库。如果用户创建的JAR放在此目录下，也会自动由扩展类加载器加载。
  ...
  ![image](https://static.lovedata.net/21-06-03-b30656b8257a2a87b29cb9030f3c823c.png)
...
![image](https://static.lovedata.net/21-06-03-318998a272ea8150c027ae317df3e9c3.png)
...
![image](https://static.lovedata.net/21-06-03-a9e401047e8a1a4da94d0adb9f03e465.png)
...
![image](https://static.lovedata.net/21-06-03-95e09d9045c8ddc8cfe7e7fb197c484d.png)
...
![image](https://static.lovedata.net/21-06-03-96ff550c5fab8a01e80107b69d52247b.png)
...
![image](https://static.lovedata.net/21-06-03-12df856ac15fe760b445181f1febe068.png)
...
![image](https://static.lovedata.net/21-06-03-05bf18f0ceb18ee952d20164706c8cac.png)

![image](https://static.lovedata.net/21-06-03-238b2b109ef988d7a56fa2b93884fe46.png)
...
![image](https://static.lovedata.net/21-06-03-5a8c6c7fc8c8fa7756c7cd4629d1b82a.png)
...
![image](https://static.lovedata.net/21-06-03-2f6640874ba04377aeca59e202477746.png)
...
![image](https://static.lovedata.net/21-06-03-1b3e037de34bc89cd1d2ac5281030d79.png)
...
![image](https://static.lovedata.net/21-06-03-455f0d5eec46a8519a57915ad584a249.png)

### 4.6.3. JDK1.2时期

在Java1.2版本中，再次改进了安全机制，增加了**代码签名**。不论本地代码或是远程代码，都会按照用户的安全策略设定，由类加载器加载到虚拟机中权限不同的运行空间，来实现差异化的代码执行权限控制。如下图所示JDK1.2安全模型：

![image](https://static.lovedata.net/21-06-03-a065288d1bf1cc503c161470f43a2094.png)
...
![image](https://static.lovedata.net/21-06-03-8d55432c6039e622004db53474801e85.png)
...
![image](https://static.lovedata.net/21-06-03-4898a969c350fc76af2d19dbd3899e97.png)
...
![image](https://static.lovedata.net/21-06-03-be0af2bbf820d3471548905de1d6bdb6.png)

![image](https://static.lovedata.net/21-06-03-fbe9bc11aa11335aee6e2568509daec4.png)
