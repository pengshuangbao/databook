...
![image](https://static.lovedata.net/20-12-22-2b42902e1fd381f627f289a2efdee72c.png)
...
![image](https://static.lovedata.net/20-12-22-0d9583808d65abae51fcf97af5877428.png)
...
![image](https://static.lovedata.net/20-12-22-15bbfe758376a799c0bce35f08e7ebd8.png)
...
![image](https://static.lovedata.net/20-12-22-a3f068deb002240d4075dba1ffc34188.png)

> 上图是 没有调用了system.gc eden区占用了 25% 下面是调用了，证明已经回收了。

![image](https://static.lovedata.net/20-12-22-04dfe50c914062b33ce47427bcb40550.png)
...
![image](https://static.lovedata.net/20-12-22-fe0ed2c5e7ed8f55c2d578320eea6d95.png)
...
![image](https://static.lovedata.net/20-12-22-8a7b57e691ba05adcb1c246809ae21bc.png)

![image](https://static.lovedata.net/20-12-22-d20da50b29549d5b90f9f1ed97e9415b.png)



![image](https://static.lovedata.net/20-12-22-b7fd2e51074f5ad7eca73a18ccd08423.png)
...
![image](https://static.lovedata.net/20-12-22-2d03c1ca7af61716933a49cd0d0118ca.png)



![image](https://static.lovedata.net/20-12-22-a5280bcf66f7487b349bcea3f16d9546.png)
...
![image](https://static.lovedata.net/20-12-22-134647666d6a7c514e084f6743bcd061.png)
...
![image](https://static.lovedata.net/20-12-22-9df0f2d43051a39f3932e5016e7198f5.png)
...
![image](https://static.lovedata.net/20-12-23-a8bc84edcc95ce0d6a60ad9389e05fd7.png)
...
![image](https://static.lovedata.net/20-12-23-1084bd15f859b5842c9a315130829c9e.png)
...
![image](https://static.lovedata.net/20-12-23-278ca8b14335a50bd591e4790de84820.png)
...
2. 进行筛选，判断此对象是否有必要执行finalize()方法
  ...
  5. <mark>finalize()方法是对象逃脱死亡的最后机会</mark>，稍后GC会对F-Queue队列中的对象进行第二次标记。如果objA在finalize()方法中与引用链上的任何一个对象建立了联系，那么在第二次标记时，objA会被移出“即将回收”集合。之后，对象会再次出现没有引用存在的情况。在这个情况下，finalize方法不会被再次调用，对象会直接变成不可触及的状态，也就是说，一个对象的finalize方法只会被调用一次。

![image](https://static.lovedata.net/20-12-23-47388196b7cb38f6a1b2d41d014eae73.png)

### Finalizer

![image](https://static.lovedata.net/20-12-23-fdad45d645037acff13d515a1be08cb7.png)
...
![image](https://static.lovedata.net/20-12-23-7ffc353ae1993a3391cd6425d5678146.png)
...
![image](https://static.lovedata.net/20-12-23-0c70c13fe94bb4ba9043b20c54f1cba1.png)

![image](https://static.lovedata.net/20-12-23-bb262595b21f9eeb01461bfe91dd94a7.png)
...
![image](https://static.lovedata.net/21-06-03-68dd8ca941fb7e86accb914b4f554e36.png)
...
![image](https://static.lovedata.net/21-06-03-790b594cde3dff83b89941900eecf1d8.png)

#### JProfiler的GC Roots溯源

我们在实际的开发中，一般不会查找全部的GC Roots，可能只是查找某个对象的整个链路，或者称为GC Roots溯源，这个时候，我们就可以使用JProfiler

![image](https://static.lovedata.net/21-06-03-9d9e0d9897d4b20544f2a8af318ec5a5.png)
...
![image](https://static.lovedata.net/20-12-23-11edf4644c2d8a5341d58ecce9237c3e.png)



![image](https://static.lovedata.net/20-12-23-105c700ade7b6b2a41f5e0df16b57d46.png)



![image](https://static.lovedata.net/20-12-23-90d20b22088d16694f868dff71efa409.png)
...
![image](https://static.lovedata.net/20-12-23-6e21563556ee3a0bf271e8f75fee37fb.png)
...
![image](https://static.lovedata.net/20-12-23-d6ef2569b4e5abf94f3d14138841d8b7.png)

![image](https://static.lovedata.net/20-12-23-53d2ef9e6e628538b9a4772105926ab7.png)
...
![image](https://static.lovedata.net/20-12-23-997de7e37807a31ea9616fa2be7f0b87.png)

> 位置变了，引用地址就变了



![image](https://static.lovedata.net/20-12-23-342fcf5619d4b7dc774f9236177bdc8a.png)
...
![image](https://static.lovedata.net/20-12-23-9ab279314d59d9fef448243eb6f8af5e.png)

![image](https://static.lovedata.net/20-12-23-b51d3acb17b84dc0287fee274adfdb29.png)
...
![image](https://static.lovedata.net/20-12-23-3d70b297e17bfaf5d05cc597ff16a766.png)
...
![image](https://static.lovedata.net/20-12-23-70252b087b05b0cc80beda6071afaf3a.png)

![image](https://static.lovedata.net/20-12-23-20fce301d388e197f4590f9605674461.png)
...
![image](https://static.lovedata.net/20-12-25-420807c63c3cf11f7616c0f49b98e513.png)
...
![image](https://static.lovedata.net/20-12-25-fbe760c75120fd9dfa46b0263a57239d.png)
...
![image](https://static.lovedata.net/20-12-25-58a7826c98fca220e1256617e2837765.png)

![image](https://static.lovedata.net/20-12-25-63e5406ab967497b79098827e06b16fb.png)
...
![image](https://static.lovedata.net/20-12-25-785350666e5ed8a2c30942ba00532443.png)

![image](https://static.lovedata.net/20-12-25-9fbc40572e185e5d49b34bd01d55384a.png)
...
![image](https://static.lovedata.net/20-12-25-148d934f83671b894ce36757fea827c3.png)



![image](https://static.lovedata.net/20-12-25-e1b69019eb44b13e377a0920b9cc5e81.png)
