...
![image](https://static.lovedata.net/21-06-03-68dd8ca941fb7e86accb914b4f554e36.png-wm)
...
![image](https://static.lovedata.net/21-06-03-790b594cde3dff83b89941900eecf1d8.png-wm)

#### JProfiler的GC Roots溯源

我们在实际的开发中，一般不会查找全部的GC Roots，可能只是查找某个对象的整个链路，或者称为GC Roots溯源，这个时候，我们就可以使用JProfiler

![image](https://static.lovedata.net/21-06-03-9d9e0d9897d4b20544f2a8af318ec5a5.png-wm)
